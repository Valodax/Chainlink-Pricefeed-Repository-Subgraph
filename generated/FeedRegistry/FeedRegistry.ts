...
export class FeedRegistry extends ethereum.SmartContract {
  ...
  getPhase(
    ...
    quote: Address,
    phaseId: i32
  ): FeedRegistry__getPhaseResultPhaseStruct {
    let result = super.call(
      "getPhase",
    ...
    return changetype<FeedRegistry__getPhaseResultPhaseStruct>(
      result[0].toTuple()
    );
  }
  ...
  getPhaseRange(
    ...
    quote: Address,
    phaseId: i32
  ): FeedRegistry__getPhaseRangeResult {
    let result = super.call(
      "getPhaseRange",
    ...
    return new FeedRegistry__getPhaseRangeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPhaseRange(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FeedRegistry__getPhaseRangeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getRoundData(
    ...
    quote: Address,
    _roundId: BigInt
  ): FeedRegistry__getRoundDataResult {
    let result = super.call(
      "getRoundData",
  ...
  latestRoundData(
    base: Address,
    quote: Address
  ): FeedRegistry__latestRoundDataResult {
    let result = super.call(
      "latestRoundData",
